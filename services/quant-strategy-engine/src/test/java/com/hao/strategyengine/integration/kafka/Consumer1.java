...
public class Consumer1 {
    ...
    private static final String GROUP_ID = "test-consumer-group1";
    private static final String CONSUMED_IDS_FILE = Paths.get("services", "quant-data-collector", "src", "main", "resources", "sent_ids_group1.log").toString();
    private static final String SENT_IDS_FILE = Paths.get("services", "quant-data-collector", "src", "main", "resources", "sent_ids_group1.log").toString();
    ...
    public void init() {
        ...
        // 1. 记录初始化参数用于排查配置问题。
        // 2. 完成订阅后输出初始化完成日志。
        logger.info("Consumer1初始化开始|Consumer1_init_start");
        ...
        logger.info("Consumer1初始化完成|Consumer1_init_done");
