...
public class Consumer1 {
    ...
    private static final String CONSUMED_IDS_FILE = "E:\\项目暂存\\quant-nano-alpha\\services\\quant-data-collector\\src\\main\\resources\\sent_ids_group1.log";
    private static final String SENT_IDS_FILE = "E:\\项目暂存\\quant-nano-alpha\\services\\quant-data-collector\\src\\main\\resources\\sent_ids_group1.log";

    private KafkaConsumer<String, String> consumer;

    public void init() {
        logger.info("========== 初始化Consumer1 ==========");
